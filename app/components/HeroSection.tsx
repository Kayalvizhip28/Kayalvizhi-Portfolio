    ...
    <div className="relative min-h-screen overflow-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-black text-white shadow-md">
        <div className="w-full px-4 py-4 flex items-center justify-between">
          {/* Name */}
          <div className="text-lg sm:text-3xl font-bold tracking-wide">
          ...
          {/* Desktop Nav */}
          <nav className="hidden sm:flex flex-wrap space-x-4 sm:space-x-6 text-sm sm:text-base font-medium">
            {[
              ['#home', 'Home'],
              ['#about', 'About'],
              ...
              ['#work', 'Projects'],
              ['#modern-web', 'Modern Web Capabilities'],
              ['#contact', 'Contact'],
            ].map(([href, label]) => (
        ...
        {/* Mobile Nav Dropdown */}
        {menuOpen && (
          <div className="sm:hidden bg-black text-white px-4 pb-4 space-y-2 text-sm font-medium">
            {[
              ['#home', 'Home'],
              ['#about', 'About'],
              ['#skills-section', 'Technical Expertise'],
      ...
      {/* Hero Content */}
      <section id="home" className="relative z-10 max-w-5xl mx-auto px-4 pt-32 pb-16">
        <div className="text-center space-y-6">
          ...
          <div className="relative inline-block px-4 sm:px-0">
            ...
            <h1 className="relative text-4xl sm:text-6xl md:text-7xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-gray-800 pb-2">
              Kayalvizhi
            </h1>
          </div>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 mt-8 sm:mt-12 px-4 sm:px-0">
            ...
            <a
              href="https://drive.google.com/file/d/1J2Qf8h27pXrGzYOV950cPcr60Y36PbV3/view?usp=sharing"
              target="_blank"
          ...
          <div className="flex justify-center gap-4 sm:gap-6 mt-8 sm:mt-12">
            {[
              ...
              { name: 'Twitter', icon: '🐦', href: 'https://twitter.com/yourtwitter' },
              { name: 'Blog', icon: '✍️', href: 'https://yourblog.com' },
            ].map((social) => (
              <a
                key={social.name}
                href={social.href}
