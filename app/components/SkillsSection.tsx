...
import {
  FaCode, FaServer, FaCloud, FaHtml5, FaCss3Alt, FaJsSquare, FaReact,
  FaPython, FaNodeJs, FaDatabase, FaProjectDiagram, FaGoogle, FaDocker,
  FaSyncAlt, FaChartLine
} from 'react-icons/fa';
...
export const SkillsSection = () => {
      ...
      skills: [
        {
          name: 'HTML5',
          tag: 'Accessibility',
          description: 'Semantic HTML5 markup with WAI-ARIA for accessibility and SEO optimization.',
          icon: <FaHtml5 className="text-orange-500 animate-bounce" />,
        },
        {
          name: 'CSS3',
          tag: 'Bootstrap',
          description: 'Modern CSS including Flexbox, Grid, animations, and responsive design patterns.',
          icon: <FaCss3Alt className="text-blue-500 animate-bounce" />,
        },
        {
          name: 'JavaScript (ES6+)',
          tag: 'ES6+',
          description: 'Modern JavaScript including async/await, modules, and asynchronous programming.',
      ...
      skills: [
        {
          name: 'Python & Flask',
          tag: 'REST APIs',
          description: 'Developing scalable backend services and RESTful APIs using Python and Flask.',
          icon: <FaPython className="text-blue-400 animate-bounce" />,
        },
        {
          name: 'Node.js',
          tag: 'Server-side',
          description: 'Building fast, scalable server-side applications using Node.js event-driven architecture.',
          icon: <FaNodeJs className="text-green-500 animate-bounce" />,
        },
        {
          name: 'MySQL',
          tag: 'Relational DB',
          description: 'Designing, querying, and managing relational databases using MySQL.',
          icon: <FaDatabase className="text-indigo-500 animate-bounce" />,
        },
        {
          name: 'RESTful API Design',
          tag: 'Swagger',
          description: 'Designing and implementing RESTful services with versioning and proper documentation.',
      ...
      skills: [
        {
          ...
          tag: 'Deployment',
          description: 'Deploying web apps and managing services using GCP App Engine and Cloud Run.',
          icon: <FaGoogle className="text-red-500 animate-bounce" />,
        },
        {
          name: 'Docker & Kubernetes',
          tag: 'Containers',
          description: 'Containerizing applications and orchestrating services with Docker and Kubernetes.',
          icon: <FaDocker className="text-blue-400 animate-bounce" />,
        },
        {
          name: 'CI/CD',
          tag: 'Automation',
          description: 'Automating builds and deployments using GitHub Actions and Cloud Build.',
          icon: <FaSyncAlt className="text-green-500 animate-bounce" />,
        },
        {
          name: 'Agile & Waterfall',
          tag: 'SDLC',
          description: 'Collaborating in Agile and Waterfall environments with sprint planning.',
  ...
  return (
    <section id="skills-section" className="py-16 px-4 bg-gray-100 scroll-mt-20">
          ...
          <div className="flex gap-4 justify-start sm:justify-center min-w-max px-2">
            {categories.map((cat) => (
              <button
                ...
                className={`flex items-center gap-2 px-5 py-2 sm:px-6 sm:py-3 rounded-full text-sm sm:text-lg font-semibold whitespace-nowrap transition-all ${
      ...
      <div id="professional-journey" className="max-w-6xl mx-auto px-4 pt-12 sm:pt-20">
        ...
        <div className="rounded-lg p-6 shadow-sm hover:shadow-md transition-all transform hover:scale-[1.02] bg-white">
          <div>
            ...
            <ul className="list-disc list-inside text-base text-gray-700 space-y-2">
              ...
              <li>Collaborated with cross-functional teams to build scalable and responsive UIs</li>
              <li>Gained hands-on experience with GCP deployment and version control using Git</li>
              <li>Developed reusable UI components and integrated dynamic data rendering for real-time updates</li>
            </ul>
          </div>
        </div>
      </div>
